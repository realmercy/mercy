...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    player.queue.clear();
    await client.sendTime(message.channel, "<a:ok:930121961542144030> | **Cleared the queue!**");
  },
  ...
  SlashCommand: {
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      player.queue.clear();
      await client.sendTime(interaction, "<a:ok:930121961542144030> | **Cleared the queue!**");
    },
  },
};
