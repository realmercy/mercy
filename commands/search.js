  ...
  run: async (client, message, args, { GuildDB }) => {
    if (!message.member.voice.channel)
      return client.sendTime(
        message.channel,
        "<:no:930114529478733834> | **You must be in a voice channel to play something!**"
      );
    if (
    ...
    if (!CheckNode || !CheckNode.connected) {
      return client.sendTime(
        message.channel,
        "<:no:930114529478733834> | **Lavalink node not connected**"
      );
    }
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      if (search.match(client.Lavasfy.spotifyPattern)) {
        ...
        switch (Searched.loadType) {
          case "LOAD_FAILED":
            ...
            return client.sendError(
              interaction,
              `<:no:930114529478733834> | **There was an error while searching**`
            );
          ...
          case "NO_MATCHES":
            ...
            return client.sendTime(
              interaction,
              "<:no:930114529478733834> | **No results were found**"
            );
          case "TRACK_LOADED":
        ...
        try {
          ...
          return client.sendTime(
            interaction,
            `<:no:930114529478733834> | **There was an error while searching:** ${err.message}`
          );
        }
        switch (res.loadType) {
          case "NO_MATCHES":
          ...
          case "SEARCH_RESULT":
            ...
            try {
              ...
              return awaitchannel.send(
                "<:no:930114529478733834> | **You didn't provide a selection**"
              );
            }
