module.exports = {
  Admins: ["906148826878996501"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/Tw7g8wYaVh", //Support Server Link
  ...
  IconURL:
    "https://cdn.discordapp.com/attachments/914744173746327633/929726833161805834/516AFD5C-62C3-41F8-B3B4-A44DE586194D.gif", //URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
